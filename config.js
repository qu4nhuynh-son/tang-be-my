...
const CONFIG = {
    introTitle: '🖐🖐🖐 Hé lô ông già của anh! 🖐🖐🖐',
    introDesc: `🎄🎄🎄🎄Chúc em giáng sinh vui vẻ, và hạnh phúc 🎄🎄🎄🎄, 
    thật ra thì anh có nhiều thứ muốn nói với em lắm
    anh muốn nói trực tiếp bằng lời nói hơn, và anh muốn nhìn ngắm khuôn mặt của em để nói lời này, không biết em cho anh cơ hội được không ?, anh biết lỗi của mình lắm rồi, anh đã suy nghĩ rất nhiều về chuyện 2 đứa mình nhiều lắm, về những gì em đã trải qua 
    ...
    quan tâm chăm sóc để ý và quan trọng là có thể cho em thấy được anh không có vô tâm, không lãng mạn như em nghĩ, anh yêu em bằng cả sự chân thành với những điều nhỏ nhặt
     nhất em nói, với anh anh điều lưu ý, và nhớ hết, anh ước gì mình có thể sửa sai và không có tỏ ra vụng về trong việc thổ lộ tình cảm của mình. Và em ơi, anh muốn hỏi là:    `,
    ...
    btnNo: '💔 Anh mơ à ! 💔 ',
    question:'Thế em đồng ý rồi hả, thiệt không đó trời anh mừng quá 😊😊',
    reasonPlaceholder: 'Lý do',
    btnReply: 'Gởi ! 💌💌',
    reply: 'Tại vì anh đáng yêu và chân thành 😊😊',
    mess: 'Anh biết mà, Anh sẽ cố gắng nỗ lực yêu hơn hơn gấp 100 lần số trên 🥰. Anh yêu em vợ  😘😘',
    messDesc: '💬💬 Em gọi cho anh được không cục vàng ơi. 💬💬',
    btnAccept: 'Ok lun 💖',
